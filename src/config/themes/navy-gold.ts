...
/**
 * Navy & Gold theme imported from preset JSON.
 *
 * Palette and core tokens come from the external theme export, while
 * extended semantic tokens inherit the site's existing navy/gold system so
 * all current components continue to render correctly.
 */
export const navyGoldTheme: ThemeConfig = {
  colors: {
    primary: {
  ...
  surfaces: {
    ...
    accentSurface: "hsl(45 88% 52%)",
    accentInkOnLight: "hsl(43 86% 44%)",
    accentInkOnDark: "hsl(45 88% 52%)",
  },
  effects: {
    shadows: {
      sharp: "2px 2px 0 0 rgb(0 0 0 / 0.4)",
      sharpLg: "8px 8px 0 0 rgb(0 0 0 / 0.55)",
      line: "0 1px 0 0 hsl(var(--border))",
      lineAccent: "0 2px 0 0 hsl(var(--accent))",
      md: "6px 6px 0 0 rgb(0 0 0 / 0.5)",
      lg: "8px 8px 0 0 rgb(0 0 0 / 0.55)",
      xl: "12px 12px 0 0 rgb(0 0 0 / 0.6)",
      accent: "4px 4px 0 0 hsl(var(--accent) / 0.25)",
