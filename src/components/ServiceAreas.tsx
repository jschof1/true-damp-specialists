              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button
                    asChild
                    size="default"
                    className="font-black text-base h-14 uppercase tracking-wider shadow-lg w-full sm:w-auto transition-all duration-300 hover:[transform:var(--hover-transform)] hover:[box-shadow:var(--hover-shadow)]"
                    style={{
                      background: theme.brand?.goldGradient ?? theme.colors.accent.DEFAULT,
